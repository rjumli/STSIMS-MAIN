<template>
    <b-modal v-model="showModal" hide-footer style="--vz-modal-width: 600px;" title="Import Course" header-class="p-3 bg-light" class="v-modal-custom" modal-class="zoomIn" centered no-close-on-backdrop>
                        ...
                        <div class="text-center">
                            ...
                            <div class="p-2 mt-4">
                                <form @submit.prevent="preview" enctype="multipart/form-data">
                                    <h5 v-if="!result">Import using Excel</h5>
                                    <p v-if="!result" class="text-muted">Please click preview to generate the entry</p>
                                    <p v-else class="text-muted">Courses imported from excel file.</p>
                                    <input v-if="!result" class="mt-2 mb-4" type="file" @change="uploadFieldChange">
